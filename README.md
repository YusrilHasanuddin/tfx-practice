...
| Web app | http://ec2-13-212-19-186.ap-southeast-1.compute.amazonaws.com:8500/v1/models/political-bias-detection-model:predict (dikarenakan saya menggunakan free tier dan saya tidak mau mengeluarkan dana tambahan untuk ini, jadi saya matikan. Bukti deployment bisa dilihat di folder submission-screenshot)|
